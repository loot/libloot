...
#include "tests/api/internals/metadata/yaml/file_test.h"
#include "tests/api/internals/metadata/yaml/group_test.h"
#include "tests/api/internals/metadata/yaml/location_test.h"
#include "tests/api/internals/metadata/yaml/message_content_test.h"
#include "tests/api/internals/metadata/yaml/message_test.h"
#include "tests/api/internals/metadata/yaml/plugin_cleaning_data_test.h"
#include "tests/api/internals/metadata/yaml/plugin_metadata_test.h"
#include "tests/api/internals/metadata/yaml/tag_test.h"
